  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        ...
        <Card className="p-4 bg-gradient-to-br from-red-50 to-orange-50 border-2 border-red-100">
        ...
        <Card className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-gray-200">
          <div className="flex items-center gap-3 mb-2">
        ...
        <Card className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-gray-200">
          <div className="flex items-center gap-3 mb-2">
      ...
      {/* Recommendation */}
      <Card className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-gray-200">
